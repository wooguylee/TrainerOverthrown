...
public static class TrainerCommands
{
    ...
    public const string KingdomQuery = "kingdomQuery";
    public const string KingdomSet = "kingdomSet";
    public const string KingdomAdd = "kingdomAdd";
}
